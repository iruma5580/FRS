<?php
  ...
  include __DIR__ . '/include/doneconn.php';
?>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Done Job Orders</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">Done Job Orders</li>
                </ol>
              </div><!-- /.col -->
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
                              ...
                              <?php else: ?>
                                <?php foreach ($assets as $a): ?>
                                  <tr>
                                    ...
                                    <td><?= e($a['assigned_person_to_fix']) ?></td>
                                    <td><?= e($a['due_date']) ?: '-' ?></td>
                      ...
                      <div class="modal-dialog modal-lg">
                        <form method="post" id="editForm" class="modal-content" novalidate>
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" id="clearFieldsBtn">Clear</button>
