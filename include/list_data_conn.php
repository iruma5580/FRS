        ...
        if ($id) {
            ...
            if ($count > 0) {
                ...
                if ($woCount > 0) {
                    ...
                    $stmt->bind_param("ssssssi",  $notes, $assigned_person_to_fix, $due_date_val, $work_order_number, $priority_status, $work_done_status, $id);
                    $stmt->execute();
                    $stmt->close();
                        header("Location: list_data.php?page=list_data&id=$id&updated=success");
                        exit;
                }
            }
